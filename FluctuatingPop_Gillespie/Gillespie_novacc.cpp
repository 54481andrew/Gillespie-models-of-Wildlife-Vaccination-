/*To do: 
-Define additional variables from the fluct model
-Define birth function
-add/figure out additional events
*/
...
//VARIABLES
int S_next, S, Iv_next, Iv, Ip_next, Ip, V_next, V, P_next, P, Npop_next, Npop, nbirths, ndeaths, ninfv, ninfp, nrecv, nrecp, S_death, Iv_death, Ip_death, V_death, P_death;
char FileName[50];
double b0, tb, Tb, b, gamv, R0p, Bp, gamp, d, Sum_rate, UniSeed, RandDeath, Picker, Sum, TimeOfReaction, t, Tmax, tick, ti;
